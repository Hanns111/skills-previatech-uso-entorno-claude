...
description: "Control previo administrativo y financiero de expedientes de pago de Ordenes de Servicio (OS) y Ordenes de Compra (OC) del MINEDU. Aplica las Pautas para la Remision de Expedientes para el Tramite de Devengado y Pago, la Ley 32069 y la Ley 27444. Usar cuando se mencione orden de servicio, orden de compra, OS, OC, carta contrato, expediente de pago, recibo por honorarios, RHE, factura, devengado, proveido, conformidad, entregable, armada, suspension de cuarta categoria, detraccion, contratacion menor a 8 UIT o locacion de servicios. Produce el veredicto, las observaciones con su base normativa y la matriz de coherencia. El formato del informe Excel lo define informe-control-previo-os-oc, Protocolo v1.1 de siete hojas."
---
